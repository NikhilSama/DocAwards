...
CREATE  TABLE IF NOT EXISTS `docawards`.`doctors` (
  ...
  `one_line_intro` VARCHAR(200) NULL ,
  `created` DATETIME NULL DEFAULT NULL ,
  `modified` DATETIME NULL DEFAULT NULL ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `docawards`.`pin_codes` (
  ...
  `Region2` VARCHAR(60) NULL DEFAULT NULL ,
  `Region3` VARCHAR(60) NULL DEFAULT NULL ,
  `Region4` VARCHAR(60) NULL DEFAULT NULL ,
  `city` VARCHAR(60) NULL DEFAULT NULL ,
  `Area1` VARCHAR(80) NULL DEFAULT NULL ,
  `Area2` VARCHAR(80) NULL DEFAULT NULL ,
