<div class="consultTypes index">
	...
	<tr>
		<td><?php echo h($consultType['ConsultType']['id']); ?>&nbsp;</td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $consultType['ConsultType']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $consultType['ConsultType']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $consultType['ConsultType']['id']), null, __('Are you sure you want to delete # %s?', $consultType['ConsultType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
